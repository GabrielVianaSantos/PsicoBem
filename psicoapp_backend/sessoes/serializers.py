...
from core.serializers import UserBasicSerializer, PacienteBasicSerializer, PsicologoBasicSerializer
...
class TipoSessaoCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TipoSessao
        fields = ['id', 'nome', 'tipo', 'valor', 'duracao_minutos', 'descricao', 'ativo']
...
class SessaoListSerializer(serializers.ModelSerializer):
    ...
    def get_pode_realizar(self, obj):
        return obj.pode_ser_realizada()
...
class SessaoDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'pode_cancelar', 'pode_remarcar', 'pode_realizar'
        ]
...
class SessaoCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Sessao
        fields = [
            'id', 'paciente_id', 'tipo_sessao_id', 'data_hora', 'status',
