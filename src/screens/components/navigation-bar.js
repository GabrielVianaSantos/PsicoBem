...
export default function Navigation() {
  return (
      ...
      >
        <Tab.Screen name="Relatorios" component={Relatorios} options={{headerShown: false}} />
        <Tab.Screen name="Home" component={Home} options={{headerShown: false}} />
        <Tab.Screen name="Sessoes" component={Sessoes} options={{headerShown: false}} />
      </Tab.Navigator>
  );
};
